...
- Step 2 : Since it gave three different tables so write a prompt to join these tables. It gave left join query and combined table is named as "CombinedTransactions1"
...
```
- Step 6 : Click on "Transform Data" tab in Power Bi tab to see data type of each column and change it to "Text","Decimal","Alphabet" etc according to column needs.
- Step 7 : A Rounded rectangle is added at top of page using Inset>Shape>Rounded rectangle.Text written inside it "Transaction Overview".              
```bash
